...
The easiest way to sync your notes between your devices is to use [[Pengenalan kepada Obsidian Sync|Obsidian Sync]]. If you already have an Obsidian Sync subscription, see how to [[Set up Obsidian Sync]].
...
Obsidian officially supports Obsidian Sync and iCloud Drive, but there are many alternative syncing solutions available from other developers, including [[Plugin komuniti]].
...
The easiest way to sync your notes on your Android device is using [[Pengenalan kepada Obsidian Sync|Obsidian Sync]].
