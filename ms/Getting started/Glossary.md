...
- [[Plugin teras]] are written by the Obsidian team and included by default.
- [[Plugin komuniti]] are written by third-party plugin developers and need to be [[Plugin komuniti#Install a community plugin|installed]] before you can use them.
...
A **snippet**, or [[Potongan CSS|CSS snippet]], changes the appearance of Obsidian, just like a [[#theme]]. Unlike themes, you can apply multiple snippets at the same time.
...
A [[Local and remote vaults|remote vault]] is a copy of your local vault that is maintained with [[Pengenalan kepada Obsidian Sync|Obsidian Sync]]. The remote vault data is updated based on changes to local data. 
