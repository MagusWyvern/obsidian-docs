...
cssclasses:
  - soft-embed
---
Properties allow you to organize information about a note. Properties contain structured data such as text, links, dates, checkboxes, and numbers. Properties can also be used in combination with [[Plugin komuniti]] that can do useful things with your structured data.
...
| `aliases` | See [[Aliases]]. |
| `cssclasses` | Allows you to style individual notes using [[Potongan CSS]]. |

### Properties for Obsidian Publish

The following properties can be used with [[Pengenalan kepada Obsidian Publish|Obsidian Publish]]:
