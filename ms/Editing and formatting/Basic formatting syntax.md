...
> Multiple adjacent blank spaces in and between paragraphs collapse to a single space when displaying a note in [[Edit and preview Markdown#Editor views|Reading view]] and on [[Pengenalan kepada Obsidian Publish|Obsidian Publish]] sites.
> 
> ```md
