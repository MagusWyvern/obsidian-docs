...
Callouts are also supported natively on [[Pengenalan kepada Obsidian Publish|Obsidian Publish]].
...
[[Potongan CSS]] and [[Plugin komuniti]] can define custom callouts, or even overwrite the default configuration.
