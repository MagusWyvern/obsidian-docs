...
Images slow the loading time of the page, and take valuable [[Pengenalan kepada Obsidian Publish|Publish]] storage space. Optimizing images allows a reduction in file size, but maintains the visual integrity of the image. 
