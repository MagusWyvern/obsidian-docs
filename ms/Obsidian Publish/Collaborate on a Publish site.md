...
---
Learn how to collaborate on your [[Pengenalan kepada Obsidian Publish|Obsidian Publish]] site with other Obsidian users. By adding your friends and colleagues as collaborators, they can publish changes to your site.
...
> [!tip]
> We recommend that you use another tool to sync changes between vaults, such as [[Pengenalan kepada Obsidian Sync|Obsidian Sync]] or [git](https://git-scm.com/).
