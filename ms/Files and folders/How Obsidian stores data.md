...
You can create a vault anywhere your operating system allows. Obsidian syncs with [[Pengenalan kepada Obsidian Sync|Obsidian Sync]], Dropbox, iCloud, OneDrive, Git, and many other third-party services.
...
Obsidian creates an `.obsidian` [[configuration folder]] in the root folder of the vault, which contains preferences specific to that vault, such as [[hotkeys]], [[Tema-tema]], and [[Plugin komuniti]].
